...
if (!roomId || !peerName) {
  // formatting should be like this http://localhost:3000/?roomId=room1&peerName=Nick
  alert('You do not have the appropriate settings to enter the room.');
  throw new Error('Check your room identification and your peer name!');
}
